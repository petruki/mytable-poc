...
import com.pj3275.mytable.controller.UserController;
import com.pj3275.mytable.model.User;
import com.pj3275.mytable.repository.UserRepository;
...
public class UserControllerUnitTest {
    ...
    public void whenCalledaddUserAndValidUser_thenCorrect() {
        ...
        assertThat(userController.addUser(user, mockedBindingResult, mockedModel)).isEqualTo("redirect:/");
    }
    ...
    public void whenCalledupdateUserAndValidUser_thenCorrect() {
        ...
        assertThat(userController.updateUser(user.getId(), user, mockedBindingResult, mockedModel)).isEqualTo("redirect:/");
    }
    ...
    public void whenCalledupdateUserAndInValidUser_thenCorrect() {
        ...
        assertThat(userController.updateUser(user.getId(), user, mockedBindingResult, mockedModel)).isEqualTo("update-user");
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void whenCalleddeleteUser_thenIllegalArgumentException() {
        assertThat(userController.deleteUser("1", mockedModel)).isEqualTo("index");
    }
}
